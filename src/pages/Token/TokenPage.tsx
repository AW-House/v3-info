...
export default function TokenPage() {
  ...
  return (
    // <Trace page="token-page" shouldLogImpression={false}>
    <PageWrapper>
      ...
      {tokenData ? (
        !tokenData.exists ? (
          <LightGreyCard style={{ textAlign: 'center' }}>
            ...
            <StyledExternalLink style={{ marginLeft: '4px' }} href={`https://redswap.io/#/add/${formattedAddress}`}>
              here.
            </StyledExternalLink>
          </LightGreyCard>
        ) : (
            ...
            <AutoColumn $gap="32px">
              <RowBetween>
                <AutoRow $gap="4px">
                  ...
                  <StyledExternalLink
                    href={getExplorerLink(ChainId.REDSTONE, formattedAddress, ExplorerDataType.ADDRESS)}
                  >
              ...
              <ResponsiveRow align="flex-end">
                ...
                {activeNetwork !== EthereumNetworkInfo ? null : (
                  <RowFixed>
                    <StyledExternalLink href={`https://redswap.io/#/add/${formattedAddress}`}>
                    ...
                    <StyledExternalLink href={`https://redswap.io/#/swap?inputCurrency=${formattedAddress}`}>
