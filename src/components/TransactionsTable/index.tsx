...
const DataRow = ({ transaction, color }: { transaction: Transaction; color?: string }) => {
  ...
  return (
    <ResponsiveGrid>
      <ExternalLink href={getExplorerLink(ChainId.REDSTONE, transaction.hash, ExplorerDataType.TRANSACTION)}>
      ...
      <Label end={1} fontWeight={400}>
        <ExternalLink
          href={getExplorerLink(ChainId.REDSTONE, transaction.sender, ExplorerDataType.ADDRESS)}
